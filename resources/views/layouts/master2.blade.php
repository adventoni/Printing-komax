                ...
                <ul class="custom-scrollbar list-unstyled" style="max-height:100vh;">
                    ...
                    <li>
                        <ul class="collapsible collapsible-accordion">
                            <li class=""><a class="collapsible-header waves-effect" href="/home-user"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a>

                            </li>
                            <li class=""><a class="collapsible-header waves-effect" href="/report-user"><i class="fa fa-file" aria-hidden="true"></i></i> File - Report</a>
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-file" aria-hidden="true"></i></i> File - Reprint<i class="fa fa-angle-down rotate-icon"></i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="/reprint-barcode-jepang" class="waves-effect">
                            ...
                            <li><a class="collapsible-header waves-effect arrow-r"><i class="fa fa-print" aria-hidden="true"></i> Transaction<i class="fa fa-angle-down rotate-icon"></i></a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="/trans-barcode-jepang" class="waves-effect"><i class="fa fa-plus-square-o" aria-hidden="true"></i>PM326 - BJepang</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
